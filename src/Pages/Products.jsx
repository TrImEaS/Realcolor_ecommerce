      ...
      <div className='flex flex-col max-sm:w-full w-[95%] bg-color rounded-lg border shadow-lg'>
        <div className='flex p-2 gap-x-3'>
          <span 
            ...
            className={`${descriptionMenu === 'desc' ? 'text-black bg-white' : 'text-white hover:text-black hover:bg-white'} font-bold rounded-xl px-2 py-1 duration-300 cursor-pointer`}>
            Descripción
          </span>
          <span className='py-1'>|</span>
          <span 
            onClick={() => setDescriptionMenu('spec')}
            className={`${descriptionMenu === 'spec' ? 'text-black bg-white' : 'text-white hover:text-black hover:bg-white'} font-bold  rounded-xl px-2 py-1 duration-300 cursor-pointer`}>
            Especificaciones
          </span>
        </div>
