    ...
    <section className="flex flex-col gap-10">
      <article className="flex flex-col gap-2">
        ...
        <p className="text-pretty">
          <b>Real Color SRL</b> dispone de un canal de venta <b>mayorista</b>. Ejecutivos de cuenta y personal técnico <b>especializado podran brindarte</b> un servicio personalizado y pensado para <b>vos</b>. 
        </p>
      </article>
