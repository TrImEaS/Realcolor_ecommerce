    ...
    <section className="flex flex-col gap-5">
      <div className="flex flex-col">
        ...
        <p className="flex flex-col gap-3">
          <span>Durante más de 25 años, hemos liderado la venta mayorista y minorista de electrodomésticos para el hogar y empresas, convirtiendo cada desafío en una oportunidad para sorprender. Nuestra pasión por la innovación y la excelencia nos mueve a ofrecerte:</span>
          ...
          <span>Empresas de renombre y miles de hogares ya confían en nuestro equipo, que trabaja con honestidad, compromiso y energía inagotable. En Real Color SRL, tu satisfacción y éxito son el motor de nuestro día a día.</span>
        </p>
      </div>
