  ...
  return (
    <section className="flex flex-col gap-5">
      <div className="flex flex-col">
        ...
        <p>
          Somos una empresa Argentina con más de 25 años comercializando insumos, accesorios y productos de 
          ...
          Conformando esta red que vincula fabricantes, importadores, retailers y consumers.
        </p>
      </div>
