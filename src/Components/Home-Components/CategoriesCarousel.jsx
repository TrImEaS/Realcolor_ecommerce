            ...
            {categories.map(c => (
              ...
              >
                <NavLink
                  ...
                  className="group relative w-[7rem] h-[7rem] max-sm:w-[5rem] max-sm:h-[5rem] my-3 overflow-hidden rounded-3xl border-2 rounded-bl-sm rounded-tr-sm shadow-border border-[#293b6c71] hover:rotate-6 duration-300 hover:rounded-tl-sm hover:rounded-br-sm hover:rounded-tr-3xl hover:rounded-bl-3xl"
                >
