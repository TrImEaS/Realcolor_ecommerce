...
export default function Nav() {
  ...
  return (
    ...
    {/*---Nav top---*/}
      ...
      <section className='md:hidden flex h-[50px] pb-3 w-full items-center justify-between text-slate-50 max-sm:justify-between max-md:px-5 max-sm:px-2 max-sm:pl-4 bg-color'> 
        {/* Categorias */}
        <CategoriesMenu/>        
