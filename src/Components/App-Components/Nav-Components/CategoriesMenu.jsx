    ...
    {/*Categorias hamburger hide menu*/}
      <div className='group rounded-full -tracking-widest'>
        <button
          ...
          className={`group`}
        >
          <p className={`${categoriesHideMenu ? 'bg-[#2a5cb3] rounded-full' : ''} group group-hover:bg-white flex items-center px-2 py-1 pl-3 duration-300 max-md:px-3 rounded-full`}>
