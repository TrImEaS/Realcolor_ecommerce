    ...
    <>
      ...
      <div className='relative group'>
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-md transition-all duration-300 ${categoriesHideMenu ? 'bg-white text-page-lightblue' : 'hover:bg-white hover:text-page-lightblue'}`}
        >
